...
Key changes:
  - Change to first convolve with PSF, then crop and paste (like v38)
"""
...
def main():
    ...
    for phi in ANGLES:
        ...
        if NOISE is True:
            conv_result_gpu = add_poisson_noise_gpu(conv_result_gpu)
    ...
    for i, phi in enumerate(ANGLES):
        ...
        padded_gpu = torch.from_numpy(padded_img.astype(np.float32)).to(DEVICE)
