...
Modified from hard_boundary_v5

Key changes:
  - Refer to fill_miss_pxs_cal_v3.py, do calibration and soft weighting in different wedges
  -Modify combine_unequal_images_gpu, fill_corr_px_gpu
"""
